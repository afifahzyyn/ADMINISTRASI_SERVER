# Modernisasi CI/CD (Continuous Intergration/Continuous Delivery)
...
2. 2. Melakukan Edit file pipeline di github
  ...
  build-and-deploy:
    ...
    - name: Build and push Docker image
      ...
      with:
        context: .
        push: true
        tags: ${{ secrets.DOCKERHUB_USERNAME }}/compro_2388010032:latest
  ...
  deploy:
    ...
    - name: SSH and deploy
      ...
      with:
        ...
        port: 22
        script: |
          docker rm -f compro_2388010032 || true
